...
/** 上电默认设定 */
#define LOADER_DEFAULT_CURRENT_SETPOINT     0.0f
#define LOADER_DEFAULT_VOLTAGE_SETPOINT     0.0f
#define LOADER_DEFAULT_POWER_SETPOINT       0.0f
#define LOADER_DEFAULT_RESISTANCE_SETPOINT  1000.0f
