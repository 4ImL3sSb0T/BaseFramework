...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, FLASH_CS_Pin|TFT_DC_Pin|TFT_CS_Pin|TFT_RST_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : USR_KEY_Pin UI_BACK_Pin UI_ENT_Pin UI_UP_Pin */
  GPIO_InitStruct.Pin = USR_KEY_Pin|UI_BACK_Pin|UI_ENT_Pin|UI_UP_Pin;
  ...
  /*Configure GPIO pin : UI_DOWN_Pin */
  GPIO_InitStruct.Pin = UI_DOWN_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(UI_DOWN_GPIO_Port, &GPIO_InitStruct);
